...
# attempt to force a colored prompt
...
# include rustup env file if installed
if [ -f ~/.cargo/bin/rustup ]; then
    . "$HOME/.cargo/env"
fi

# automatic JAVA_HOME variable evaluation
# looks like spaghetti - no idea how to fix
...
# if exa is installed we prefer it to the
# tree command
